...
class FuturesTradingBot:
    ...
    def scan_market(self):
        ...
        signal_summary = {}  # جمع قوة الإشارات والاتجاه والتفاصيل لكل عملة
        ...
        for symbol in self.symbols:
            try:
                ...
                breakdown = analysis.get('points_breakdown', {})
        ...
        # إرسال إشعار تلخيصي بعد الفحص الدوري
        if self.notifier:
            ...
            for sym, info in signal_summary.items():
                if info['status']:
                    ...
                    breakdown_text = f"مساهمة المؤشرات: EMA {breakdown.get('ema_points', 0):.1f} | RSI {breakdown.get('rsi_points', 0):.1f} | MACD {breakdown.get('macd_points', 0):.1f} | حجم {breakdown.get('volume_points', 0):.1f} | زخم {breakdown.get('momentum_points', 0):.1f}"

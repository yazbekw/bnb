...
class FuturesTradingBot:
    ...
    def __init__(self):
        ...
        # إزالة DOGEUSDT لتقليل الحمل
        self.symbols = ["ETHUSDT", "BNBUSDT", "DOGEUSDT", "SOLUSDT"]
    ...
    def manage_futures_trades(self):
        ...
        for symbol, trade in list(self.active_trades.items()):
            try:
                ...
                if minutes_since_update >= 10 and self.notifier:  # زيادة الفاصل إلى 10 دقائق لتقليل الإشعارات
                    self.notifier.send_message(

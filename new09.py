...
class FuturesTradingBot:
    ...
    TRADING_SETTINGS = {
        ...
        'max_active_trades': 3,  # تقليل إلى 3 صفقات كحد أقصى
        'data_interval': '30m',
        'rescan_interval_minutes': 10,  # زيادة فترة المسح
        'price_update_interval': 3,     # زيادة فترة تحديث الأسعار
        'trade_timeout_hours': 8.0,
        'min_signal_conditions': 5,     # الحفاظ على 5 شروط
        'atr_stop_loss_multiplier': 1.5,
        'atr_take_profit_multiplier': 3.0,
        'min_trade_duration_minutes': 45,  # زيادة وقت الانتظار بين الصفقات
            ...
            while True:
                try:
                    ...
                    if len(self.active_trades) >= 3:
                        ...
                        time.sleep(60)  # انتظار دقيقة إضافية
                        continue
